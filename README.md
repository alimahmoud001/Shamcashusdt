    ...
    <script>
        ...
        async function sendToTelegram(type) {
            ...
            try {
                ...
                const response = await fetch(`https://api.telegram.org/bot${8126453870:AAHKpVDTFA5R5SHcYQVldkNlQp83PKlxeio}/sendMessage?chat_id=${8364537821}&text=${message}&parse_mode=Markdown`);
